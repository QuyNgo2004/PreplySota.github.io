...
<nav class="main-header navbar navbar-expand navbar-white navbar-light text-sm">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item d-sm-inline-block">
            <a href="../preply/home.php" target="_blank" class="nav-link"><i style="color: #f08700;" class="fas fa-reply"></i> Trở về website của bạn</a>
        </li>
        <li class="nav-item dropdown">
            <a id="dropdownSubMenu-info" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle"><i style="color: #f08700;" class="fas fa-cogs"></i> Cài đặt</a>
        ...
        <li class="nav-item dropdown">
            <a class="nav-link" data-toggle="dropdown" href="#">
                <i style="color: #f08700;" class="fas fa-bell"></i> Thông báo
        ...
        <li class="nav-item d-sm-inline-block">
            <a href="index.php?com=user&act=logout" class="nav-link"><i style="color: #f08700;" class="fas fa-sign-out-alt mr-1"></i>Đăng xuất</a>
        </li>
    </ul>
</nav>