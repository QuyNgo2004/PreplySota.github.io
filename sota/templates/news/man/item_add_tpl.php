                        ...
                        <div class="card card-primary card-outline card-outline-tabs">
                            ...
                            <div class="card-body card-article">
                                        ...
                                        <div class="tab-pane fade show <?=($k=='vi')?'active':''?>" id="tabs-lang-<?=$k?>" role="tabpanel" aria-labelledby="tabs-lang">
                                            <?php if(isset($config['news'][$type]['name']) && $config['news'][$type]['name'] == true) { ?>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control for-seo" name="data[hoten]" id="name" placeholder="Nhập tên:" value="<?=@$item['hoten']?>" required>
                                                </div>
                                            <?php } ?>
                                            <?php if(isset($config['news'][$type]['gmail']) && $config['news'][$type]['gmail'] == true) { ?>
                                                <div class="form-group">
                                                    <label for="Name">Gmail:</label>
                                                    <input type="text" class="form-control for-seo" name="data[gmail]" id="name" placeholder="Nhập gmail:" value="<?=@$item['gmail']?>" required>
                                                </div>
                                            <?php } ?>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control for-seo" name="data[nghenghiep]" id="nghenghiep" placeholder="Nhập Nghề Nghiệp khách hàng" value="<?=@$item['nghenghiep']?>" required>
                                            </div>
                                            <?php }?>
                                            ...
                                            <?php if(isset($config['news'][$type]['link']) && $config['news'][$type]['link'] == true) { ?>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="data[link]" id="link_dichvu"  placeholder="Link" value="<?=@$item['link']?>">
                                                </div>
                                            <?php } ?>
                                            <?php if(isset($config['news'][$type]['noidung']) && $config['news'][$type]['noidung'] == true) { ?>
                                                <div class="form-group">
                                                    <label for="noidung<?=$k?>">Nội dung (<?=$k?>):</label>
                                                    <textarea class="form-control for-seo <?=(isset($config['news'][$type]['noidung_cke']) && $config['news'][$type]['noidung_cke'] == true)?'form-control-ckeditor':''?>" name="data[noidung<?=$k?>]" id="noidung<?=$k?>" rows="5" placeholder="Nội dung (<?=$k?>)"><?=@$item['noidung'.$k]?></textarea>
                                                </div>
                                            <?php } ?>
                                        </div>
                                    <?php } ?>
                                ...
                                <?php if(isset($config['news'][$type]['video']) && $config['news'][$type]['video'] == true) { ?>
                                    <div class="form-group">
                                        <label for="link_video">Lĩnh vực:</label>
                                        <input type="text" class="form-control" name="data[nghenghiep]" id="content_video" placeholder="Video content" value="<?=@$item['nghenghiep']?>">
                                        </div>
