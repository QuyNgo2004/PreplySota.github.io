<?php
	class Functions
	{
		...
		public function checkURL($index=false)
		{
			...
			$url = '';
			$urls = array('Home','Home.html','trang-chu','trang-chu.html');

			if(array_key_exists('REDIRECT_URL', $_SERVER))
			{
				$root = str_replace("/Home.php", "", $_SERVER['PHP_SELF']);
			...
			if($index) array_push($urls,"Home.php");
			else if(array_search('Home.php', $urls)) $urls = array_diff($urls, ["Home.php"]);
